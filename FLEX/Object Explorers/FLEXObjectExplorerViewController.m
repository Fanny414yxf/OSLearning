...
//                objc_property_t property = (__bridge objc_property_t)([[self.filteredProperties objectAtIndex:row] property]);
                objc_property_t property = ( objc_property_t)([[self.filteredProperties objectAtIndex:row] property]);
